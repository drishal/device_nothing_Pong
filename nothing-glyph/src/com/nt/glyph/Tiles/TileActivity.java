...
import com.nt.glyph.Settings.SettingsActivity;
...
public class TileActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (sourceClass.getClassName().equals("com.nt.glyph.Tiles.GlyphTileService")
            || sourceClass.getClassName().equals("com.nt.glyph.Tiles.TorchTileService")) {
